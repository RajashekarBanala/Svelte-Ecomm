...
<div class="card">
    <header class="card-header">
        ...
        <footer class="card-footer">
            <button class="p-2 round variant-glass-primary"on:click={()=>addToCart(product.id)}>Add</button>
            <button class="p-2 round variant-glass-error"on:click={()=>removeFromCart(product.id)}>Remove</button>
        </footer>
</div>